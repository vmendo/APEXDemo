...
SOURCE_DIR="/home/opc/APEXDemo/aux/custom/base_release"
TARGET_DIR="/home/opc/APEXDemo/my_projects/demo/dist/releases/next/changes/base-release/_custom"

# List of SQL files to append
FILES=("populate_eba_demo.sql")
